// Modified Original Context Logic
...
export const ApiProvider = ({ children }) => {
  ...
  const searchRecipe = async () => {
    const response = await apiClient.get(
      `${API_BASE_URL}/complexSearch?query=${searchData}&apiKey=${apikey}&addRecipeInformation=true`
    );
  ...
  useEffect(() => {
    async function randomSearch() {
      const response = await apiClient.get(
        `${API_BASE_URL}/${randomNumber}/information?apiKey=${apikey}`
      );
