      ...
      <div className="flex flex-wrap justify-center">
        {bulkRecipe?.map((dt) => (
          ...
          <div class="relative flex flex-col m-6 bg-white shadow-sm border border-slate-200 rounded-lg w-96">
            ...
            <div class="p-4">
              <div class="mb-4 flex ">
                <span className="rounded-full mr-1 bg-cyan-600 py-0.5 px-2.5 border border-transparent text-xs text-white transition-all shadow-sm  text-center">
                  {dt.diets[0]}
                </span>
                <span className="rounded-full bg-cyan-600 py-0.5 px-2.5 border border-transparent text-xs text-white transition-all shadow-sm  text-center">
                  {dt.diets[1]}
                </span>
              </div>
