    ...
    <div className="xl:max-w-[90%] 2xl:max-w-[90rem] mx-auto">
      <div className="my-5 p-2 flex rounded-xl    transition-all  hover:shadow-md  ">
        ...
        <div className=" flex flex-col justify-around">
          <div>
            <h3 className="text-xl font-bold text-gray-900 sm:text-2xl lg:text-xl xl:text-2xl">
              {title}
            </h3>
            <div className="py-2">
              <span className="rounded-full mr-1 bg-gray-500 py-0.5 px-2.5 border border-transparent text-sm text-white transition-all shadow-sm  text-center">
                {diet[0]}
              </span>
              <span className="rounded-full bg-gray-500 py-0.5 px-2.5 border border-transparent text-sm text-white transition-all shadow-sm  text-center">
                {diet[1]}
              </span>
            </div>
            <p
